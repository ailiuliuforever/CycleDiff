...
| 参数 | 默认值 | 说明 |
|------|--------|------|
| `--cfg` | configs/rsi2map/map_ae_kl_256x256_d4.yaml | 配置文件路径 |
| `--ckpt` | results/map_ae_kl_256x256_d4/model-10.pt | 模型 checkpoint 路径 |
...
|------|--------|------|
| `--ckpt` | results/map_ae_kl_256x256_d4/model-10.pt | 模型 checkpoint 路径 |
| `--save_dir` | evaluation/vae/res/quick_eval | 结果保存目录 |
| `--batch_size` | 8 | 批大小 |
