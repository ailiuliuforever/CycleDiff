    ...
    def __init__(
        ...
        if self.accelerator.is_main_process:
            ...
            swanlab.init(
                ...
                experiment_name=f"cycle_train_{datetime.now().strftime('%Y%m%d_%H%M%S')}",
                config=config_dict,
                description="CycleDiff Cycle-Consistency Training for Image Translation"
            )
        ...
        with tqdm(initial=self.step, total=self.train_num_steps, disable=not accelerator.is_main_process) as pbar:
            ...
            while self.step < self.train_num_steps:
                ...
                if accelerator.is_main_process:
                    ...
                    swanlab.log({
                        "Generator/loss_gen_toal": loss_gen_toal.item(),
                        "Generator/loss_idt": loss_idt.item(),
                        "Generator/loss_G_adv_A": loss_G_adv_A.item(),
                        ...
                        "Discriminator/loss_mcl_A": loss_mcl_A.item(),
                        "Discriminator/loss_mcl_B": loss_mcl_B.item(),
                        "Discriminator/loss_ldm_D": loss_ldm_D.item(),
                        "Learning_Rate/d1": self.opt_d1.param_groups[0]['lr'],
                        "Learning_Rate/d2": self.opt_d2.param_groups[0]['lr'],
                        "Learning_Rate/G": self.opt_G.param_groups[0]['lr'],
                        "Learning_Rate/D": self.opt_D.param_groups[0]['lr'],
